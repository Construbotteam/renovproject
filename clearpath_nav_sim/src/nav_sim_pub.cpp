...
void action(float *position_row, float *position_col)
{
  ...
  {
    *(position_row + hv_i.I() - 1) = hv_position_row[hv_i - 1].D();
    *(position_col + hv_i.I() - 1) = hv_position_col[hv_i - 1].D();
...
int main(int argc, char *argv[])
{
  ...
  float position_row[8]={754,438,632,1052,1710,1070,1686,1432};
  float position_col[8]={1450,1150,417,752,1398,1626,878,422};
