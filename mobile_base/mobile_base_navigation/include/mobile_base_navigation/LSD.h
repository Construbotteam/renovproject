...
#ifdef WIN32
    #ifdef LSD_EXPORTS
        #define LSD_EXPORT __declspec(dllexport)
    #elif defined(LSD_STATIC)
        #define LSD_EXPORT
    #else
        #define LSD_EXPORT __declspec(dllimport)
    #endif
#else
    #define LSD_EXPORT
#endif
// #if defined _WIN32
// #if LIBLSD_BUILD
// #define LIBLSD_API __declspec(dllexport)
// #else
// #define LIBLSD_API __declspec(dllimport)
// #endif
// #else
// #define LIBLSD_API
// #endif
