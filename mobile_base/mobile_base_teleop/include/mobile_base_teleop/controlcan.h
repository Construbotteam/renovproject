...
/*
  The following device ID is 
  supported by this can analyst 
*/
...
/*
  ...
  ERR_CAN_OVERFLOW --- internal FIFO overflow of can controller
	ERR_CAN_ERRALARM --- error alarm of can controller
  ERR_CAN_PASSIVE	 --- negative error of can controller
	ERR_CAN_LOSE		 --- loss of arbitration
	ERR_CAN_BUSERR	 --- can bus error
*/
