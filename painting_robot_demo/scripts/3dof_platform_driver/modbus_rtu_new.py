...
def main():
    ...
    try:
        ...
        # logger.info(master.execute(3, cst.WRITE_SINGLE_REGISTER, 290, output_value=9)) #136/24 cm -24,10000 pulse 1 rpm,negtive up,positive up
        ...
        # logger.info(master.execute(1, cst.WRITE_SINGLE_REGISTER, 282, output_value=1))  # enable Climb Driver
        ...
        logger.info(master.execute(2, cst.WRITE_SINGLE_REGISTER, 290, output_value=4)) #1===6,5degree -22.5#5.5 -7.5+(fu)clockwise 10000 pulse 1 rpm,negtive up,positive up
        ...
        #
        print(master.execute(1, cst.READ_HOLDING_REGISTERS, 202, 1))
        # while 1:
        # #     pass
        #     time.sleep(0.1)
