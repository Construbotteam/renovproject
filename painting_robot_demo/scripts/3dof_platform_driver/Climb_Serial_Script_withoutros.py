...
class ClimbRobot:
    def __init__(self,PORT,Baudrate):
        ...
        try:
            self.ser = serial.Serial(port=self.PORT, baudrate=self.Baudrate, bytesize=serial.EIGHTBITS, parity=serial.PARITY_EVEN, stopbits=1,timeout=0.3, xonxoff=0,rtscts=True,dsrdtr=True)#PARITY_NONE
        except:
...
def main():
    ...
    # print climb_robot.Send_message_to_port('04060004000249ca')#('0406003200002850')#('040300050000559e')#('040600140001085b')#('010600140001080e')
    print climb_robot.Send_message_to_port('010300b5000195ec')#('0406003200002850')#('040300050000559e')#('040600140001085b')#('010600140001080e')
